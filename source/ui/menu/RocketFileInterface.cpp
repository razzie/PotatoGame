...
ui::menu::RocketFileInterface::RocketFileInterface(raz::IMemoryPool* memory) :
	m_memory(memory),
	m_archive("../data/gui.res", memory)
{
}

resource::ArchiveReader* ui::menu::RocketFileInterface::getArchive()
{
	return &m_archive;
}

Rocket::Core::FileHandle ui::menu::RocketFileInterface::Open(const Rocket::Core::String& path)
{
...
void ui::menu::RocketFileInterface::Close(Rocket::Core::FileHandle file_handle)
{
...
size_t ui::menu::RocketFileInterface::Read(void* buffer, size_t size, Rocket::Core::FileHandle file_handle)
{
	File* file = reinterpret_cast<File*>(file_handle);
...
bool ui::menu::RocketFileInterface::Seek(Rocket::Core::FileHandle file_handle, long offset, int origin)
{
	File* file = reinterpret_cast<File*>(file_handle);
...
size_t ui::menu::RocketFileInterface::Tell(Rocket::Core::FileHandle file_handle)
{
	File* file = reinterpret_cast<File*>(file_handle);
