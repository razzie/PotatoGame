...
static void createPlatforms(ui::shape::PlatformRingShape::PlatformVector& platforms, raz::Random& random, unsigned radius)
{
	...
	auto tighten = [](ui::shape::PlatformRingShape::Platform& platform)
	{
	...
	for (unsigned i = 0; i < 2; ++i)
	{
		for (unsigned j = 0; j < platform_count; ++j)
		{
			...
			ui::shape::PlatformRingShape::Platform platform;
...
static void insertPlatforms(const ui::shape::PlatformRingShape::PlatformVector& platforms, raz::Random& random, ui::core::MeshBuffer<>& meshbuffer)
{
...
static void insertWires(const ui::shape::PlatformRingShape::PlatformVector& platforms, raz::Random& random, unsigned radius, unsigned complexity, ui::core::MeshBuffer<>& meshbuffer)
{
	...
	for (unsigned i = 0; i < wires; ++i)
	{
		...
		ui::shape::WireShape wire(p1, p2, 8, 0.25f * distance);
		wire.generate(meshbuffer);
	}
}

ui::shape::PlatformRingShape::PlatformRingShape(unsigned radius, unsigned complexity) :
	m_radius(radius),
	m_complexity(complexity)
{
}

void ui::shape::PlatformRingShape::generate(raz::Random& random, PlatformVector& platforms, ui::core::MeshBuffer<>& meshbuffer) const
{
