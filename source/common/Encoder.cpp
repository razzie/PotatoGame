...
void common::encode(unsigned char* buf, size_t len)
{
	for (size_t i = 0; i < len; ++i)
		buf[i] = shuffle[buf[i]];
}

void common::decode(unsigned char* buf, size_t len)
{
	for (size_t i = 0; i < len; ++i)
		buf[i] = deshuffle[buf[i]];
}

void common::genShuffleArray()
{
...
void common::genDeshuffleArray(const unsigned char* shuffle)
{
	std::cout << "{" << std::endl;
